        ...
        <div style="display: flex; justify-content: space-around; margin-top:30px;">
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap:10px; border:solid 2px black; padding:10px 20px;">
                        <div style="display: flex; align-items:center; gap:5px;">
                            ...
                            <button style="background-color: white; border-radius:5px; cursor: pointer;">Retirar en Tienda</button>
                        </div>
                        <div style="display: flex; align-items:center; gap:5px;">
                            ...
                            <button style="background-color: white; border-radius:5px; cursor: pointer;">Entrega a Domicilio</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div style="padding:20px; border:2px solid black; margin-top:10px; display:flex; flex-direction: column; gap:1rem;">
                    ...
                    <button style="background-color:#bdf76c; padding:5px; border-radius:5px; cursor:pointer;">Ir a Pagar</button>
                </div>
            </div>
        </div>
