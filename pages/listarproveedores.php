<?php
    ...
    if($_SERVER["REQUEST_METHOD"]==="POST"){
        $band = true;
        $filtro = $_POST["filtro"];
        $queryFiltrado = "SELECT * FROM proveedor WHERE nombre LIKE '%$filtro%'";
...
<head>
    ...
    <link rel="stylesheet" href="../css/listarproveedores.css">
    <script src="../js/index.js"></script>
</head>
<body>
    <?php
        include "./modaleliminarproveedor.php";
    ?>
    <header class="header">
    ...
    <main class="main">
        <div class="contenedor-izquierda">
            ...
            <img src="../img/proveedores.jpg" alt="Proveedores">
        </div>
        <div class="contenedor-derecha">
            <h2>LISTADO DE PROVEEDORES</h2>
            <form method="POST" class="formulario">
                <h3>Buscar</h3>
                <input type="text" name="filtro" placeholder="Ingrese el proveedor a buscar">
                <button>
            ...
            <div class="contenedor-tabla">
                <table>
                    ...
                    <tbody>
                        <?php
                            if($band === false){
                                while($row=mysqli_fetch_assoc($resultadosProveedores)){                        
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="./actualizarproveedores.php?id=<?php echo $row['id_proveedor']?>">
                                    ...
                                    <td>
                                        ...
                                        onclick="mostrarModalEliminarProveedor(<?php echo $row['id_proveedor'];?>)"
                                        >
                        ...
                        ?>
                                <tr>
                                    <td><?php echo $row2["id_proveedor"];?></td>
                                    <td><?php echo $row2["nombre"];?></td>
                                    <td><?php echo $row2["apellido"];?></td>
                                    <td><?php echo $row2["ruc"];?></td>
                                    <td><?php echo $row2["telefono"];?></td>
                                    <td><?php echo $row2["email"];?></td>
                                    <td><?php echo $row2["direccion_domicilio"];?></td>
                                    <td>
                                        <a href="./actualizarproveedores.php?id=<?php echo $row2['id_proveedor']?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-pencil" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#0000ff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                <path d="M4 20h4l10.5 -10.5a1.5 1.5 0 0 0 -4 -4l-10.5 10.5v4" />
                                                <path d="M13.5 6.5l4 4" />
                                    ...
                                    <td>
                                        <button class="boton-eliminar" 
                                            onclick="mostrarModalEliminarProveedor(<?php echo $row2['id_proveedor'];?>)"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FF0000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                <path d="M4 7l16 0" />
