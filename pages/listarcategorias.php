...
<body>
    <?php
        include "./modaleliminarcategoria.php";
    ?>
    <header class="header">
                    ...
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="boton-eliminar"
                                            onclick="mostrarModalEliminarCategoria(<?php echo $row['id_categoria'];?>)"
                                            >
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="boton-eliminar"
                                        onclick="mostrarModalEliminarCategoria(<?php echo $row2['id_categoria'];?>)"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FF0000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                <path d="M4 7l16 0" />
