        ...
        <main class="main">
            <div class="centro-ayuda">
                ...
                <div class="contenedor-listado">
                    <p>Estado del pedido y entrega</p>
                    <p>Devoluciones y cambios</p>
                    <p>Garantías</p>
                    <p>Mi Cuenta</p>
                </div>
            </div>
            <div class="revisar-gestionar">
                <h2>Revisa y gestiona tus pedidos</h2>
                <div class="contenedor-listado">
                    <ul>
                        <li>Sigue tus compras</li>
                        <li>Cancela tus pedidos</li>
                        <li>Haz tus solicitudes de devoluciones</li>
                        <li>Revisa tus boletas y tickets de cambio</li>
                        <li>Ingresa tus casos</li>
                    </ul>
                </div>
            </div>
        </main>
